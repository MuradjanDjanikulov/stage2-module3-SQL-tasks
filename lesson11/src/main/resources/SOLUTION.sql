-- 1. Update grade 5 for subject name 'End of Suburbia: Oil Depletion and the Collapse of the American Dream'
UPDATE Subject SET grade = 5 WHERE name = 'End of Suburbia: Oil Depletion and the Collapse of the American Dream';

-- 2. Update groupNumber 8 for student 'Tremaine Worvill'
